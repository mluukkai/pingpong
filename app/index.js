...
const connectionString = process.env.CONNECT_STRING || 'postgresql://postgres:postgres@localhost:5432/postgres';
...
app.get('/', async (req, res) => {
  ...
  if (true || connection) {
    res.send('<p>pingpong: <a href="/pingpong">pingpong</a></p>'+ randomNumber + '<p>' + ip.address() + '</p>');
  } else {
